...
GPUS=$2
BATCH_PER_GPU=${32}
EXP_NAME=vit-b_layer12_lr1e-4_099_099_pred_x0__min_snr_5__fp16_bs_FOOT_1stRun
...
OPENAI_LOGDIR=$OPENAI_LOGDIR \
    torchrun --nproc_per_node=2 --master_port=23456 scripts_vit/image_train_vit.py \
    --data_dir $DATA_DIR --image_size 32 --class_cond False --save_interval=1000 --diffusion_steps 1000 \
